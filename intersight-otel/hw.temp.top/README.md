...
```
# HELP intersight_hw_temp_top_avg
# TYPE intersight_hw_temp_top_avg gauge
intersight_hw_temp_top_avg{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 36 1764767773100
# HELP intersight_hw_temp_top_max
# TYPE intersight_hw_temp_top_max gauge
intersight_hw_temp_top_max{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 36 1764767773136
# HELP intersight_hw_temp_top_min
# TYPE intersight_hw_temp_top_min gauge
intersight_hw_temp_top_min{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 36 1764767773141
```
