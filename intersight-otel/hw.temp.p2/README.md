...
```
# HELP intersight_hw_temp_p2_avg
# TYPE intersight_hw_temp_p2_avg gauge
intersight_hw_temp_p2_avg{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 69.9155548297409 1764767773227
# HELP intersight_hw_temp_p2_max
# TYPE intersight_hw_temp_p2_max gauge
intersight_hw_temp_p2_max{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 70.70433492867235 1764767773124
# HELP intersight_hw_temp_p2_min
# TYPE intersight_hw_temp_p2_min gauge
intersight_hw_temp_p2_min{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 69.5 1764767773108
```

- iserver command [documentation](https://github.com/datacenter/iserver/blob/main/doc/ocp/iotel/README.md)

```
# iserver set ocp iotel --cluster bm1 --suffix iac --mode poller --template hw.temp.p2 --target server-ip:10.10.10.21-23 --pmode set --dir C:\tmp\imonitor\intersight-otel\ --no-confirm
