...
```
# HELP intersight_hw_temp_middle_avg
# TYPE intersight_hw_temp_middle_avg gauge
intersight_hw_temp_middle_avg{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 47.7141919195934 1764767773137
# HELP intersight_hw_temp_middle_max
# TYPE intersight_hw_temp_middle_max gauge
intersight_hw_temp_middle_max{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 48 1764767773120
# HELP intersight_hw_temp_middle_min
# TYPE intersight_hw_temp_middle_min gauge
intersight_hw_temp_middle_min{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 47 1764767773101
```

- iserver command [documentation](https://github.com/datacenter/iserver/blob/main/doc/ocp/iotel/README.md)

```
# iserver set ocp iotel --cluster bm1 --suffix iac --mode poller --template hw.temp.middle --target server-ip:10.10.10.21-23 --pmode set --dir C:\tmp\imonitor\intersight-otel\ --no-confirm
