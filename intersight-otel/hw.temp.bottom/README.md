...
```
# HELP intersight_hw_temp_bottom_avg
# TYPE intersight_hw_temp_bottom_avg gauge
intersight_hw_temp_bottom_avg{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 37 1764767773116
# HELP intersight_hw_temp_bottom_max
# TYPE intersight_hw_temp_bottom_max gauge
intersight_hw_temp_bottom_max{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 37 1764767773143
# HELP intersight_hw_temp_bottom_min
# TYPE intersight_hw_temp_bottom_min gauge
intersight_hw_temp_bottom_min{server_ip="10.10.10.21",server_name="server1",telemetry_sdk_name="intersight-otel"} 37 1764767773145
```

- iserver command [documentation](https://github.com/datacenter/iserver/blob/main/doc/ocp/iotel/README.md)

```
# iserver set ocp iotel --cluster bm1 --suffix iac --mode poller --template hw.temp.bottom --target server-ip:10.10.10.21-23 --pmode set --dir C:\tmp\imonitor\intersight-otel\ --no-confirm
